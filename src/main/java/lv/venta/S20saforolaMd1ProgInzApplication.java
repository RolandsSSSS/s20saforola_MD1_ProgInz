	...
	public CommandLineRunner testModel(ICashierRepo cashierRepo, ICityRepo cityRepo, IDriverRepo driverRepo, ITicketRepo ticketRepo, ITripRepo tripRepo) {
		...
		return new CommandLineRunner() {
			...
			public void run(String... args) throws Exception {
				...
				Trip t4 = new Trip(Rei3, d1, "29/06/2023", (float) 1.3);
				tripRepo.save(t1);
				tripRepo.save(t2);
				tripRepo.save(t3);
				tripRepo.save(t4);
				...
				Ticket tc5 = new Ticket("29/06/2023 14:00", t4, (float) 3.99, false, c2);
				Ticket tc6 = new Ticket("29/06/2023 12:00", t4, (float) 0.00, true, c2);
				ticketRepo.save(tc1);
				ticketRepo.save(tc2);
				ticketRepo.save(tc3);
				ticketRepo.save(tc4);
